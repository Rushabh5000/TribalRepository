<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="ReportYouth.aspx.cs" Inherits="ReportYouth" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="Youth Report" Font-Bold="True" Font-Names="Calibri" Font-Size="XX-Large"></asp:Label>
