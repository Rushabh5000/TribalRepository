...
public partial class ReportYouth : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = Server.MapPath("~/ReportYouth.rdlc");
    ...
    private DataTable getReportData()
    {
        ...
        {
            using (MySqlDataAdapter sda = new MySqlDataAdapter("SELECT * FROM profiledetails WHERE Role= 'Youth'", conn))
            {
                sda.Fill(dt);
