<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="ReportAgency.aspx.cs" Inherits="ReportAgency" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="Agency Report" Font-Bold="True" Font-Names="Calibri" Font-Size="XX-Large"></asp:Label>
    ...
    <div class="WrapText">
        ...
        <asp:GridView ID="GridView1" AllowSorting="True" OnSorting="GridView1_Sorting" runat="server" AutoGenerateColumns="False" DataKeyNames="pid" OnPageIndexChanging="GridView1_PageIndexChanging"
            BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Font-Names="Calibri" Font-Size="Large" HorizontalAlign="Center">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Name" HeaderText="Agency Name" ItemStyle-HorizontalAlign="Center" ItemStyle-Font-Size="Large" SortExpression="Name" />
