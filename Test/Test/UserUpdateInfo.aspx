<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserUpdateInfo.aspx.cs" Inherits="UserUpdateInfo" %>
    ...
    <form id="form1" runat="server" method="post">
        <div class="parent">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="a col-md-2 control-label">Age</label>
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <textarea rows="3" cols="50" placeholder="street No ,Area" name="addr" id="addr" runat="server" class="form-control" />
                    </div>
                </div>
                <br />
